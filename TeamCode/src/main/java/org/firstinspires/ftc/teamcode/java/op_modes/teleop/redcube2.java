...
//public class redcube2 {
@Autonomous(name = "redcube2", group = "auto")
public class redcube2 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        lift.lift(3);
        ad.gyroDrive(AutoDrive.DRIVE_SPEED,330 , 0);
        intake.outtake(2);
        intake.stop();
        lift.lower(3);
        lift.stop();
        ad.gyroDrive(AutoDrive.DRIVE_SPEED,-230 , 0);
